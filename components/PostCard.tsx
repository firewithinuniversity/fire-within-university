...
export default function PostCard({ post, readingTimeMinutes }: Props) {
  ...
  return (
    <article className="bg-brown-card/70 rounded-2xl overflow-hidden border border-white/[0.06] hover:border-gold/15 hover:shadow-kindle hover:-translate-y-1 transition-[border-color,box-shadow,transform] duration-300 flex flex-col group">
      {imageUrl ? (
