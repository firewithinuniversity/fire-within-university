...
export default function RelatedPosts({ posts }: Props) {
  ...
  return (
    <section aria-label="Related posts" className="border-t border-brown/10 pt-10 mt-4">
      <div className="flex items-end justify-between gap-4 mb-7">
        ...
        <Link
          href="/blog"
          className="text-sm font-semibold text-orange hover:text-orange-hover transition-colors flex-shrink-0 flex items-center gap-1 hover:gap-2 duration-150"
        >
