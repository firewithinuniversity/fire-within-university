  ...
  return (
    ...
    >
      ...
      <span
        ...
        className="text-orange font-medium underline decoration-dotted underline-offset-2 cursor-pointer hover:text-orange-hover transition-colors duration-150"
      >
        {children}
      </span>
