...
export default function Footer() {
  ...
  const socialLinks = [
    {
      href: "https://www.facebook.com/profile.php?id=61590441583251",
      label: "Facebook",
      icon: (
    ...
    {
      href: "https://www.youtube.com/@FireWithinUnv",
      label: "YouTube",
      icon: (
        <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
    ...
    {
      href: "https://www.instagram.com/firewithinunv/",
      label: "Instagram",
      icon: (
        <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
    ...
    {
      href: "https://www.tiktok.com/@firewithinunv",
      label: "TikTok",
      icon: (
        <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
    ...
    {
      href: "https://x.com/TheFireWithinUn",
      label: "X (Twitter)",
      icon: (
        <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
    ...
    {
      href: "https://open.spotify.com/user/315dlj4ma4gvra6jhbsjjkmjrp7y",
      label: "Spotify",
      icon: (
        <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
