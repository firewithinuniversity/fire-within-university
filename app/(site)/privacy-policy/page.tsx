  ...
  return (
    <div className="max-w-3xl mx-auto px-4 py-14">
      ...
      <div className="mb-10">
        ...
        <h1 className="font-serif text-4xl font-bold text-brown mb-2">Privacy Policy</h1>
      ...
      <div className="space-y-10 text-brown/80 leading-relaxed">
        ...
        {/* 2 */}
        <section>
          <h2 className="font-serif text-xl font-bold text-brown mb-3">2. What Information We Collect</h2>

          <h3 className="font-semibold text-brown mb-2 mt-4">Information You Give Us</h3>
          ...
          <h3 className="font-semibold text-brown mb-2 mt-6">Information Collected Automatically</h3>
          <ul className="list-disc list-inside space-y-2 text-sm">
            <li>
        ...
        {/* 3 */}
        <section>
          <h2 className="font-serif text-xl font-bold text-brown mb-3">3. Cookies</h2>
          <p>
        ...
        {/* 4 */}
        <section>
          <h2 className="font-serif text-xl font-bold text-brown mb-3">4. How We Use Your Information</h2>
          <ul className="list-disc list-inside space-y-2 text-sm">
        ...
        {/* 5 */}
        <section>
          <h2 className="font-serif text-xl font-bold text-brown mb-3">5. Third-Party Services</h2>
            ...
            {[
              ...
              <li key={name} className="flex gap-2">
                ...
                <span>
                  ...
                  <a href={url} target="_blank" rel="noopener noreferrer" className="text-orange underline">
                    Privacy Policy ↗
                  </a>
                </span>
              </li>
        ...
        {/* 6 */}
        <section>
          <h2 className="font-serif text-xl font-bold text-brown mb-3">6. Your Rights</h2>
          <p className="mb-3">
          ...
          <ul className="list-disc list-inside space-y-2 text-sm">
            ...
            <li><strong>Deletion:</strong> Request that we delete your personal data. Use the{" "}
              <a href="/contact" className="text-orange underline">contact form</a> or email us directly.</li>
          ...
          <p className="mt-4 text-sm">
            ...
            or use our <a href="/contact" className="text-orange underline">contact form</a>.
        ...
        {/* 7 */}
        <section>
          <h2 className="font-serif text-xl font-bold text-brown mb-3">7. Children&apos;s Privacy</h2>
          <p>
        ...
        {/* 8 */}
        <section>
          <h2 className="font-serif text-xl font-bold text-brown mb-3">8. Data Security</h2>
          <p>
        ...
        {/* 9 */}
        <section>
          <h2 className="font-serif text-xl font-bold text-brown mb-3">9. Data Retention</h2>
          <ul className="list-disc list-inside space-y-2 text-sm">
        ...
        {/* 10 */}
        <section>
          <h2 className="font-serif text-xl font-bold text-brown mb-3">10. Changes to This Policy</h2>
          <p>
        ...
        {/* 11 */}
        <section>
          <h2 className="font-serif text-xl font-bold text-brown mb-3">11. Contact Us</h2>
          <p>
