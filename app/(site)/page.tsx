          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5">
            {PATHWAYS.map((p, i) => (
              <SectionReveal key={p.href} delay={i * 80} distance={20}>
                <Link
                  href={p.href}
                  className="group relative flex flex-col h-full bg-brown-card/50 border border-white/[0.06] rounded-2xl p-6 transition-[border-color,background-color,transform,box-shadow] duration-300 hover:bg-brown-card/80 hover:border-gold/20 hover:-translate-y-1 hover:shadow-kindle"
                >
